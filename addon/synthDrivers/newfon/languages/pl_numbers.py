...
def dajPostacSlownaDziesiatki(znak):
 ...
 if znak=='1':
  napis=u'dziesięć'
 if znak=='2':
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), u'dzieścia')
 if znak=='3':
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), u'dzieści')
 if znak=='4':
  napis=dajPolaczoneNapisy(dajFragmentNapisu(dajPostacSlownaJednejCyfry(znak), 1, dajDlugoscNapisu(dajPostacSlownaJednejCyfry(znak))-1), u'dzieści')
 if (znak>='5') and (znak<='9'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), u'dziesiąt')
 return napis

def dajPostacSlownaNascie(znak):
 napis=''
 if (znak=='1') or (znak=='4'):
  napis=dajPolaczoneNapisy(dajFragmentNapisu(dajPostacSlownaJednejCyfry(znak), 1, dajDlugoscNapisu(dajPostacSlownaJednejCyfry(znak))-1), u'naście')
 if (znak=='2') or (znak=='3') or (znak=='7') or (znak=='8'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), u'naście')
 if znak=='6':
  napis=u'szesnaście'
 if (znak=='5') or (znak=='9'):
  napis=dajPolaczoneNapisy(dajFragmentNapisu(dajPostacSlownaJednejCyfry(znak), 1, dajDlugoscNapisu(dajPostacSlownaJednejCyfry(znak))-1), u'tnaście')
 return napis
...
def dajPostacSlownaSetki(znak):
 ...
 if znak=='2':
  napis=u'dwieście'
 if (znak=='3') or (znak=='4'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), u'sta')
 if (znak>='5') and (znak<='9'):
  napis=dajPolaczoneNapisy(dajPostacSlownaJednejCyfry(znak), u'set')
 return napis
...
def dajOdmianeTryliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'try', znak)
 return odmiana

def dajOdmianeTryliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda(u'try', znak)
 return odmiana

def dajOdmianeKwadryliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'kwadry', znak)
 return odmiana

def dajOdmianeKwadryliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda(u'kwadry', znak)
 return odmiana

def dajOdmianeKwintyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'kwinty', znak)
 return odmiana

def dajOdmianeKwintyliarda(znak):
 odmiana=''
 odmiana=dajOdmianeLiarda(u'kwinty', znak)
 return odmiana

def dajOdmianeSekstyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'seksty', znak)
 return odmiana

def dajOdmianeSeptyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'septy', znak)
 return odmiana

def dajOdmianeOktyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'okty', znak)
 return odmiana

def dajOdmianeNonyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'nony', znak)
 return odmiana

def dajOdmianeDecyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'decy', znak)
 return odmiana

def dajOdmianeUndecyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'undecy', znak)
 return odmiana

def dajOdmianeDuodecyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'duodecy', znak)
 return odmiana

def dajOdmianeCentyliona(znak):
 odmiana=''
 odmiana=dajOdmianeLiona(u'centy', znak)
 return odmiana
...
def dajNapisZLiczbamiWPostaciSlownej(napis):
 ...
 while indeks<=dlugosc:
  ...
  if (indeks-poprzedni)==1:
   ...
   napis_1=dajPolaczoneNapisy(napis_1, dajNapisZLiczbaWPostaciSlownej(dajFragmentNapisu(napis, poprzedni, (indeks-poprzedni))))
 return " "+napis_1+" "

def numbersToWords(numbers):
	return dajNapisZLiczbamiWPostaciSlownej(numbers)
